...
{
  "needsRAG": false,
  "directAnswer": "Hello! I'm EduVeda, your educational AI assistant. I can help you understand your uploaded documents. Upload PDFs or images and ask me questions!",
...
{
  "needsRAG": false,
  "directAnswer": "I'm EduVeda, an AI-powered educational assistant. I help students understand their study materials by answering questions based on uploaded documents.",
  ...
  private fallbackClassification(query: string): ClassificationResult {
    ...
    if (
      ...
      return {
        needsRAG: false,
        directAnswer:
          "Hello! I'm EduVeda, your educational AI assistant. Upload documents and ask me questions about them!",
    ...
    if (metaQuestions.some((q) => trimmed.includes(q))) {
      return {
        needsRAG: false,
        directAnswer:
          "I'm EduVeda, an AI-powered educational assistant. I help you understand your study materials by answering questions based on your uploaded documents. Just upload PDFs or images and ask me anything!",

"""
EduVeda model setup script for translation models.
...
def setup_nllb() -> None:
  ...
  print()
  print("Setting up NLLB-200 for EduVeda...")
...
def setup_models() -> None:
  ...
  print("=" * 60)
  print("EduVeda Translation Model Setup (NLLB-200)")
  print("=" * 60)
  print()
  ...
  print()
  print("=" * 60)
  print("✅ EduVeda model setup complete!")
  print("=" * 60)
  print()
  print("NLLB-200 is now cached and will run offline.")
  print("This is the only translation model used by EduVeda.")

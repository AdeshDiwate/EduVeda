...
const RequirementCard = ({ title, description, className = "" }: { title: string, description: string, className?: string }) => {
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-sm border-2 ${isOpen ? 'border-sky-400/60 shadow-md bg-sky-50/30' : 'border-sky-100/60'} transition-all duration-300 overflow-hidden cursor-pointer hover:shadow-md hover:border-sky-300/60 group ${className}`}
      onClick={() => setIsOpen(!isOpen)}
    >
      <div className="p-5 flex items-center justify-between gap-4">
        <h4 className={`font-bold text-lg leading-tight ${isOpen ? 'text-sky-800' : 'text-gray-800'} group-hover:text-sky-700 transition-colors`}>
          {title}
        </h4>
        <svg
          className={`w-5 h-5 text-sky-400 transition-transform duration-300 transform flex-shrink-0 ${isOpen ? 'rotate-180' : 'rotate-0'}`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <div className={`px-5 overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-40 pb-5 opacity-100' : 'max-h-0 opacity-0'}`}>
        <p className="text-gray-600 text-sm leading-relaxed border-t border-sky-100/60 pt-3">
          {description}
        </p>
      </div>
    </div>
...
const PitchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50/40 via-white to-sky-50/40">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20 pt-32 sm:pt-36">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-sky-500/80 leading-tight">
            We are the Creators of EduVeda
          </h2>
        </div>
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <svg className="w-6 h-6 text-sky-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section ref={problemRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-white" >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-sky-50/60 border-l-4 border-sky-400/60 p-6 rounded-r-lg mb-8 transition-all duration-300">
              <div
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-center text-gray-900 group-hover:text-sky-700 transition-colors flex-1">
                  Multilingual Content Generation Crisis
                </h3>

                <button className="p-2 rounded-full hover:bg-sky-200/50 text-sky-600 transition-colors flex-shrink-0 w-10 flex justify-end">
                  {isCrisisExpanded ? (
      ...
      <section ref={requirementsRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-sky-50/40" >
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={benchmarksRef} className="grid md:grid-cols-2 gap-6">
            {benchmarks.map((benchmark, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg shadow-lg p-6 border-l-4 border-sky-400/60 transform transition-all duration-500 ${visibleBenchmarks.includes(index)
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sky-600/80 font-semibold">
      ...
      {/* Results Section */}
      <section ref={resultsRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-sky-50/40 to-white" >
        <div className="max-w-6xl mx-auto text-center">
          <div className={`transform transition-all duration-1000 ${showResults ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            }`}>
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-sky-500/80 mb-8">
              And Guess What,
            </h2>
      ...
      <section ref={solutionRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-white" >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-gradient-to-br from-sky-50/60 to-sky-100/60 rounded-2xl p-8 shadow-xl border border-sky-200/50 hover:shadow-2xl transition-shadow duration-300">
              <div className="mb-4">
                <Zap className="w-16 h-16 text-sky-600/80" strokeWidth={1.5} />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Astonishing Performance
              </h3>
              <p className="text-gray-700 text-lg mb-4 leading-relaxed">
                Works on a <strong className="text-sky-600/80">1.3 GB RAM</strong> memory and <strong className="text-sky-600/80">4 GB</strong> of disc space
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Works <strong className="text-sky-600/80">completely offline!</strong>
              </p>
            </div>

            <div className="bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-2xl p-8 shadow-xl border border-sky-200/50 hover:shadow-2xl transition-shadow duration-300">
              <div className="mb-4">
                <Wrench className="w-16 h-16 text-sky-600/80" strokeWidth={1.5} />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Built with Open Source
              </h3>
              <p className="text-gray-700 text-lg mb-4 leading-relaxed">
                Built using <strong className="text-sky-600/80">open source</strong> and <strong className="text-sky-600/80">minimal external tooling</strong>
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                We leveraged <strong className="text-sky-600/80">open weight models</strong> from proprietary providers like <strong className="text-sky-600/80">DeepSeek</strong> and <strong className="text-sky-600/80">Meta</strong>
              </p>
            </div>
          </div>

          <div className="bg-gradient-to-r from-sky-400/80 to-sky-500/80 rounded-2xl p-8 shadow-2xl text-center border-4 border-sky-300/60">
            <h3 className="text-3xl font-bold text-white mb-6">
              DeepSeek R1 1.5B and NLLB 600M
            </h3>
            <p className="text-xl text-sky-50/90">
              To be precise ;)
            </p>
          </div>
        </div>
      ...
      {/* Journey Section */}
      <section ref={journeyRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-sky-50/40" >
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 transform transition-all duration-1000 ${showJourney ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center border-t-4 border-sky-400/60 hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl font-bold text-sky-600/80 mb-2">5</div>
              <div className="text-gray-700 font-semibold">Features</div>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg text-center border-t-4 border-sky-300/60 hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl font-bold text-sky-500/80 mb-2">200+</div>
              <div className="text-gray-700 font-semibold">Commits</div>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg text-center border-t-4 border-sky-500/60 hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl font-bold text-sky-600/80 mb-2">11</div>
              <div className="text-gray-700 font-semibold">Days of R&D</div>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg text-center border-t-4 border-sky-400/60 hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl font-bold text-sky-600/80 mb-2">18</div>
          ...
          <div className={`mb-16 transform transition-all duration-1000 delay-200 ${showJourney ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-sky-100/50">
              ...
              <div className="relative">
                {/* Timeline Line */}
                <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-sky-200/60 via-sky-300/70 to-sky-400/80"></div>
                ...
                <div className="space-y-12 relative z-10">
                  {[
                    ...
                    <div key={index} className="flex items-center gap-6">
                      <div className="shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-sky-300/70 to-sky-400/80 shadow-lg flex items-center justify-center border-4 border-white">
                        <div className="w-3 h-3 rounded-full bg-white"></div>
                      </div>
                      <div className="flex-1 bg-gradient-to-r from-sky-50/60 to-white rounded-xl p-6 shadow-md border border-sky-100/50">
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-sky-600/80 font-bold text-lg">{item.phase}</span>
                          <span className="text-sky-600/80 font-semibold">{item.progress}%</span>
                        </div>
                        ...
                        <div className="w-full bg-sky-100/50 rounded-full h-3 overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-sky-300/70 to-sky-400/80 rounded-full transition-all duration-1000"
          ...
          <div className={`mb-16 transform transition-all duration-1000 delay-300 ${showJourney ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            ...
            <div className="bg-gray-900 rounded-xl shadow-2xl overflow-hidden border-2 border-gray-800">
              <div className="bg-gray-800 px-4 py-3 flex items-center gap-2">
                ...
                <span className="ml-4 text-gray-400 text-sm font-mono">github.com/ayuxy027/EduVeda</span>
              </div>
              <div className="p-4">
                <img
          ...
          <div className={`space-y-8 mb-16 transform transition-all duration-1000 delay-500 ${showJourney ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
            ...
            <div className="bg-gradient-to-r from-sky-50/60 to-amber-50/60 rounded-xl p-8 border-l-4 border-sky-400/60 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Extensive Research
              </h3>
              <p className="text-gray-700 text-lg mb-2">
                We read over <strong className="text-sky-600/80">200+ references</strong> including Stack Overflow, Medium articles, and web surfing using our agents
              </p>
              <p className="text-gray-700 text-lg mb-2">
                Spending <strong className="text-sky-600/80">16 hours</strong> in total R&D!
              </p>
              <p className="text-xl font-bold text-sky-600/80 mt-4">
                But all this costed us <span className="text-sky-500/80">zero</span> xD
              </p>
            </div>
          </div>
          ...
          <div className={`space-y-8 mb-16 transform transition-all duration-1000 delay-700 ${showJourney ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            ...
            <div className="bg-gradient-to-r from-sky-50/60 to-amber-50/60 rounded-xl p-8 border-l-4 border-sky-400/60 shadow-lg">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mt-4">
                <strong className="text-sky-600/80">It would have been easy to inject a Gemini/Groq endpoint, but it would have been a wrapper than an innovation.</strong>
              </p>
            </div>
          </div>
          ...
          <div className={`space-y-8 mb-16 transform transition-all duration-1000 delay-800 ${showJourney ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            ...
            <div className="bg-white rounded-2xl p-10 shadow-2xl border-2 border-sky-200/50">
          ...
          <div className={`space-y-8 mb-16 transform transition-all duration-1000 delay-900 ${showJourney ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            ...
            <div className="bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-xl p-8 border-l-4 border-sky-400/60 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                We Pushed Harder
              </h3>
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                We tested <strong className="text-sky-600/80">open weight models</strong> which had <strong className="text-sky-600/80">RL or CoT approach</strong> to get rid of API dependency.
              </p>
              <p className="text-2xl font-bold text-sky-600/80 text-center mt-6">
                And it worked like magic!!
              </p>
              <p className="text-xl font-bold text-sky-600/80 text-center mt-4">
          ...
          <div className={`space-y-8 mb-16 transform transition-all duration-1000 delay-1100 ${showJourney ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="bg-gradient-to-br from-amber-50/60 to-sky-50/60 rounded-xl p-8 border-l-4 border-sky-400/60 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mt-4">
                Many of them <strong className="text-sky-600/80">crashed</strong> as we wanted to <strong className="text-sky-600/80">exceed the requirements</strong>.
              </p>
            </div>
          </div>
          ...
          >
            <div className="bg-gradient-to-r from-sky-400/80 to-sky-500/80 rounded-2xl p-10 shadow-2xl text-center text-white border-4 border-sky-300/60">
              ...
              <div className="flex items-center justify-center gap-2 mt-8">
                ...
                <Flame className="w-10 h-10 text-sky-300" strokeWidth={2} />
              </div>
            </div>
          </div>
          ...
          >
            <div className="bg-white/90 rounded-2xl p-8 shadow-xl border border-sky-200/60">
              ...
              <div className="mb-8 bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-xl p-6 border border-sky-200/60">
                <div className="flex items-center gap-3 mb-4">
                  <Zap className="w-8 h-8 text-sky-600/80" strokeWidth={2} />
                  <h4 className="text-2xl font-bold text-gray-900">Translation Pipeline</h4>
                  <span className="ml-auto px-4 py-1 bg-sky-500/20 text-sky-700 font-bold rounded-full text-sm">
                    10× Speedup
                  </span>
                </div>
                      ...
                      <BarChart data={[
                        ...
                        <Bar dataKey="time" radius={[8, 8, 0, 0]}>
                          {Array.from({ length: 5 }).map((_, index) => (
                            <Cell key={`cell-${index}`} fill={index === 4 ? '#0ea5e9' : '#38bdf8'} />
                          ))}
                        </Bar>
                      </BarChart>
                    </ResponsiveContainer>
              ...
              <div className="mb-8 bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-xl p-6 border border-sky-200/60">
                <div className="flex items-center gap-3 mb-4">
                  <Brain className="w-8 h-8 text-sky-600/80" strokeWidth={2} />
                  <h4 className="text-2xl font-bold text-gray-900">Language Model</h4>
                </div>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-white/80 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-sky-600">1.5B</div>
                    <div className="text-sm text-gray-600">Parameters</div>
                  </div>
                  <div className="bg-white/80 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-sky-600">~2.2GB</div>
                    <div className="text-sm text-gray-600">RAM Usage</div>
                  </div>
                  <div className="bg-white/80 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-sky-600">~78%</div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-xl p-6 border border-sky-200/60">
                  <div className="flex items-center gap-3 mb-4">
                    <Database className="w-8 h-8 text-sky-600/80" strokeWidth={2} />
                ...
                <div className="bg-gradient-to-br from-sky-50/60 to-amber-50/60 rounded-xl p-6 border border-sky-200/60">
                  <div className="flex items-center gap-3 mb-4">
                    <Building2 className="w-8 h-8 text-sky-600/80" strokeWidth={2} />
          ...
          <div className={`mt-20 text-center transform transition-all duration-1000 delay-[2000ms] ${showJourney ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex flex-col items-center justify-center gap-4">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-sky-500 to-amber-600 leading-tight py-2">
          ...
          <div className={`mt-16 mb-8 transform transition-all duration-1000 delay-1700 ${showJourney ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/"
                className="bg-gradient-to-r from-sky-400/80 to-sky-500/80 text-white font-semibold px-8 py-4 rounded-full text-lg shadow-lg hover:shadow-xl hover:from-sky-500/90 hover:to-sky-600/90 transition-all duration-300 transform hover:scale-105"
              >
                Home
              </Link>
              <Link
                to="/benchmarks"
                className="bg-white text-sky-600 border-2 border-sky-400/80 font-semibold px-8 py-4 rounded-full text-lg shadow-lg hover:shadow-xl hover:bg-sky-50 hover:border-sky-500/90 transition-all duration-300 transform hover:scale-105"
              >
                Benchmarks
              </Link>
            </div>

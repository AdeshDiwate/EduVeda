...
const BenchmarksPage: React.FC = () => {
  ...
  const llmReasoningData = [
    { name: 'DeepSeek-R1\n1.5B', score: 78, fill: '#0ea5e9' },
    { name: 'Llama 3.2\n3B', score: 72, fill: '#38bdf8' },
    { name: 'Gemma 2\n2B', score: 55, fill: '#fdba74' },
    { name: 'Qwen 2.5\n0.5B', score: 35, fill: '#fed7aa' },
  ];

  const llmInferenceSpeedData = [
    { name: 'DeepSeek-R1', speed: 40, fill: '#0ea5e9' },
    { name: 'Llama 3.2', speed: 20, fill: '#38bdf8' },
  ...
  const translationLanguageData = [
    { name: 'NLLB-200\n600M', languages: 200, indic: 22, fill: '#0ea5e9' },
    { name: 'IndicTrans2\n1.1B', languages: 22, indic: 22, fill: '#38bdf8' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
              Technical <span className="text-sky-500">Benchmarks</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-sky-500 text-white text-sm font-bold">1</span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    <strong className="text-gray-900">Final Recommendation:</strong> <strong className="text-sky-600">DeepSeek-R1 1.5B</strong> is
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-sky-50/50">
                      ...
                      <td className="p-4 text-gray-700"><span className="font-semibold text-sky-600">High (~78%)</span></td>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              <ResponsiveContainer width="100%" height={380}>
                <BarChart data={llmMemoryData} margin={{ top: 20, right: 30, bottom: 20, left: 20 }}>
                  ...
                  <Bar dataKey="disk" fill="#0ea5e9" name="Disk Size (Quantized)" radius={[6, 6, 0, 0]} />
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
                <li>
                  ...
                  <span className="font-semibold text-sky-600">DeepSeek-R1 achieves ~78% (target met).</span>
                </li>
                <li>
                  <span className="font-semibold text-gray-900">Inference Speed (On-Device):</span>{' '}
                  Target ≥25 t/s on CPU-only 4–8 GB RAM devices.{' '}
                  <span className="font-semibold text-sky-600">DeepSeek-R1 sustains 35–45 t/s (target met).</span>
                </li>
                <li>
                  <span className="font-semibold text-gray-900">Memory Footprint:</span>{' '}
                  Target ≤1.5 GB disk, ≤3 GB RAM for the reasoning model.{' '}
                  <span className="font-semibold text-sky-600">DeepSeek-R1 runs at ~1.1 GB disk and ~2.2 GB RAM (target met).</span>
                </li>
                <li>
                  ...
                  <span className="font-semibold text-sky-600">Benchmarks show R1 has the highest hallucination resistance among tested SLMs.</span>
                </li>
              </ul>
            </div>
        ...
        {activeSection === 'translation' && (
          <div className="space-y-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-sky-500 text-white text-sm font-bold">2</span>
            ...
            <div className="bg-sky-50 border-l-4 border-sky-500 p-4 rounded-r-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    <strong className="text-sky-600">NLLB-200 (distilled 600M)</strong> provides the best balance of translation quality,
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-sky-50/50">
                      ...
                      <td className="p-4 text-center"><span className="font-semibold text-sky-600">200+</span></td>
                      <td className="p-4 text-center"><span className="font-semibold text-sky-600">22+</span></td>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={translationSizeData} margin={{ top: 20, right: 20, bottom: 80, left: 20 }}>
                    ...
                    />
                    <Legend wrapperStyle={{ paddingTop: '20px' }} />
                    <Bar dataKey="modelSize" fill="#0ea5e9" name="Model Size" radius={[6, 6, 0, 0]} />
                    <Bar dataKey="diskUsage" fill="#38bdf8" name="Disk Usage" radius={[6, 6, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-sky-50/50">
                      ...
                      <td className="p-4 text-center"><CheckCircle2 className="w-5 h-5 text-sky-500 mx-auto" /></td>
                      <td className="p-4 text-center"><CheckCircle2 className="w-5 h-5 text-sky-500 mx-auto" /></td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 text-center"><AlertTriangle className="w-5 h-5 text-sky-500 mx-auto" /></td>
                      <td className="p-4 text-center"><AlertTriangle className="w-5 h-5 text-sky-500 mx-auto" /></td>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-gray-100">
                        ...
                        <tr>
                          ...
                          <td className="p-3 text-center text-sky-600 font-semibold">1.25x</td>
                        ...
                        <tr>
                          ...
                          <td className="p-3 text-center text-sky-600 font-semibold">2.5x</td>
                        ...
                        <tr>
                          ...
                          <td className="p-3 text-center text-sky-600 font-semibold">3.3x</td>
                        ...
                        <tr className="bg-sky-50/50">
                          ...
                          <td className="p-3 text-center text-sky-600 font-bold">~0:30</td>
                          <td className="p-3 text-center text-sky-600 font-bold">10x</td>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      ...
                      <p className="text-sm text-gray-700">Process 6-12 sentences simultaneously instead of one-by-one. <span className="font-semibold text-sky-600">8-10x speedup</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <h5 className="font-semibold text-gray-900 mb-2">2. Parallel Batch Processing</h5>
                      <p className="text-sm text-gray-700">ThreadPoolExecutor with 4 workers processes multiple batches in parallel. <span className="font-semibold text-sky-600">2-3x additional speedup</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <h5 className="font-semibold text-gray-900 mb-2">3. Translation Caching</h5>
                      <p className="text-sm text-gray-700">LRU cache with 1000 entries for instant retrieval of repeated translations. <span className="font-semibold text-sky-600">Near-instant for cached content</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <h5 className="font-semibold text-gray-900 mb-2">4. Multi-threading Configuration</h5>
                      <p className="text-sm text-gray-700">Optimized OMP, MKL, NUMEXPR, PyTorch threads for maximum CPU utilization. <span className="font-semibold text-sky-600">All CPU cores utilized</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <h5 className="font-semibold text-gray-900 mb-2">5. CPU-Optimized Parameters</h5>
                      <p className="text-sm text-gray-700">Greedy decoding (num_beams=1), lower penalties for faster inference. <span className="font-semibold text-sky-600">Faster with maintained quality</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <h5 className="font-semibold text-gray-900 mb-2">6. Auto-Detected Batch Sizing</h5>
                      <p className="text-sm text-gray-700">Optimal batch size per device (CPU: 6-10, GPU: 12). <span className="font-semibold text-sky-600">Optimal for each hardware</span>.</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 md:col-span-2">
                      ...
                      <p className="text-sm text-gray-700">Persistent Python server keeps model loaded in memory. <span className="font-semibold text-sky-600">Zero startup overhead</span>.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
                <li>
                  ...
                  <span className="font-semibold text-sky-600">NLLB-200 achieves high human-rated adequacy/fluency across 15+ evaluated languages (target band reached).</span>
                </li>
                <li>
                  ...
                  <span className="font-semibold text-sky-600">NLLB-200 covers 200+ languages and 22+ Indic languages (target met).</span>
                </li>
                <li>
                  ...
                  <span className="font-semibold text-sky-600">Benchmarks show NLLB-200 preserves technical terms and notation with near-perfect symbol accuracy.</span>
                </li>
                <li>
                  ...
                  <span className="font-semibold text-sky-600">NLLB-200 (600M) runs on CPU-only systems with ~600 MB model size and ~1.2 GB disk usage (target met).</span>
                </li>
              </ul>
            </div>
          </div>

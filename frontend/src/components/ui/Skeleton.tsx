...
export const MessageSkeleton: React.FC = () => (
  <div className="flex justify-start mb-6">
    <div className="max-w-[85%] rounded-2xl p-4 bg-white border-2 border-sky-100 space-y-3">
...
export const ResourceSkeleton: React.FC = () => (
  <div className="bg-white/80 backdrop-blur-md rounded-xl p-4 border-2 border-sky-100">

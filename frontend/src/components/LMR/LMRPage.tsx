      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-800 mb-2 sm:mb-3">
            <span className="text-sky-400">LMR</span> for Revisions
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-stretch">
          ...
          <aside className="lg:w-80 xl:w-96 flex-shrink-0">
            <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border-2 border-sky-200/60 p-5 sm:p-6 sticky top-24 space-y-6">
              {/* History */}
              <LMRHistoryComponent
              ...
              >
                ...
                >
                  {!uploadedFile ? (
                    <>
                      <svg
                        className="w-12 h-12 sm:w-14 sm:h-14 text-sky-400 mx-auto mb-3"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <>
                      <svg
                        className="w-12 h-12 sm:w-14 sm:h-14 text-sky-500 mx-auto mb-3"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              <div>
                <label className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-gray-800 mb-2.5">
                  ...
                  Language{" "}
                  {hasContent && (
                    <span className="text-xs text-sky-500">(Translate)</span>
                  )}
                </label>
                <select
                ...
                {hasContent && selectedLanguage !== currentDisplayLanguage && (
                  <button
                    ...
                    className="mt-2 w-full px-3 py-2 bg-sky-500 hover:bg-sky-600 text-white text-sm font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-wait flex items-center justify-center gap-2"
                  >
                    {isTranslating ? (
                      <>
                        <svg
              ...
              <div>
                ...
                <select
                  ...
                  disabled={hasContent}
                  className="w-full px-3 py-2.5 bg-white border-2 border-sky-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent text-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {tones.map((tone) => (
                ...
                {!hasContent ? (
                  <div className="text-center py-16 sm:py-20">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 rounded-full bg-sky-100 flex items-center justify-center">
                      <svg
                        className="w-10 h-10 sm:w-12 sm:h-12 text-sky-400"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    {activeView === "pdf" && (
                      <div className="text-center py-12">
                        ...
                        <button
                          ...
                          className="px-8 py-4 bg-sky-500 hover:bg-sky-600 text-white rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:scale-105 font-semibold text-lg flex items-center gap-3 mx-auto disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {downloadingPDF ? (
                            <>
                              <svg

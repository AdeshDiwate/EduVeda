    ...
    <div>
      {!summary ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border-2 border-sky-200 overflow-hidden shadow-md">
            <div className="bg-gradient-to-r from-sky-50 to-sky-100 border-b-2 border-sky-200 px-6 py-4">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 gap-4">
                {summary.keyTopics.map((topic, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-4 p-4 bg-sky-50 rounded-lg border border-sky-200 hover:shadow-md transition-shadow"
                  >

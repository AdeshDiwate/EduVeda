...
const QuizTab: React.FC<QuizTabProps> = ({ quizData, isLoading }) => {
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl border-2 border-sky-200 p-8 text-center">
          <div className="mb-6">
            <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-sky-100 flex items-center justify-center">
            ...
            <p className="text-lg text-gray-600">
              You scored{" "}
              <span className="font-bold text-sky-600">{score}</span> out of{" "}
          ...
          <button
            onClick={handleReset}
            className="bg-sky-500 hover:bg-sky-600 text-white font-semibold py-3 px-8 rounded-lg transition-all"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Quiz card */}
      <div className="bg-white rounded-xl border-2 border-sky-200 p-6 sm:p-8">
        <div className="mb-4 flex items-center gap-3">
          ...
          <span className="text-xs bg-sky-50 text-sky-700 px-3 py-1.5 rounded-full border border-sky-200 font-medium">
            {quiz.subject}
          </span>
        </div>
        ...
        <div className="mt-8 flex justify-between items-center">
          <button
            ...
            className="px-6 py-2.5 border-2 border-sky-200 text-sky-600 font-semibold rounded-lg hover:bg-sky-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            ← Previous
          </button>
          ...
          {currentQuiz === quizData.length - 1 ? (
            <button
              ...
              className="px-8 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-semibold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Submit Quiz
            </button>
          ) : (
            <button
              ...
              className="px-6 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-semibold rounded-lg transition-all"
            >
              Next →
            </button>
          )}

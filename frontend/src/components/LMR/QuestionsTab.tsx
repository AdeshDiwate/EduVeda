      ...
      {!questions || questions.length === 0 ? (
        ...
        <div className="space-y-4 sm:space-y-6">
          {questions.map((qa) => (
            <div
              key={qa.id}
              className="bg-white rounded-xl border-2 border-sky-200 hover:shadow-lg transition-all duration-300 overflow-hidden hover:border-sky-300"
            >
              <div className="p-5 sm:p-6">
                ...
                <div className="mb-4">
                  <span className="inline-block bg-sky-50 text-sky-700 text-xs sm:text-sm px-3 py-1.5 rounded-full border border-sky-200 font-medium">
                    {qa.subject}
                  </span>
                </div>
                <div className="bg-gradient-to-r from-sky-50 to-yellow-50 border-2 border-sky-200 p-4 sm:p-5 rounded-lg">
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1">
                      <span className="font-semibold text-sky-600 text-sm sm:text-base block mb-1">
                        Answer:
                      </span>

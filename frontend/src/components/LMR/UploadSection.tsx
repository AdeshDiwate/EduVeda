  ...
  return (
    <div className="mb-6">
      <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800 mb-3 sm:mb-4">
        Upload documents for <span className="text-sky-400">Last Minute Recall</span>
      </h2>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          {!uploadedFile ? (
            <>
              <svg className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-sky-400 mb-2 sm:mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              <svg className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-sky-500 mb-2 sm:mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-xs sm:text-sm text-sky-600 mt-1 font-medium">Uploaded</p>
            </>
          )}
        </div>
        ...
        {isProcessing && (
          <div className="mt-4 sm:mt-5">
            <div className="w-full bg-sky-200 rounded-full h-2 sm:h-2.5">
              <div className="bg-sky-500 h-full rounded-full animate-pulse w-3/4 transition-all"></div>
            </div>
            <p className="text-xs sm:text-sm text-sky-600 mt-2 font-medium">Processing...</p>
          </div>
        )}
      </div>
      ...
      <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-sky-50 p-3 sm:p-4 rounded-xl border-2 border-sky-200 hover:border-sky-300 transition-all">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="bg-sky-100 p-2 sm:p-2.5 rounded-lg flex-shrink-0">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-sky-50 p-3 sm:p-4 rounded-xl border-2 border-sky-200 hover:border-sky-300 transition-all sm:col-span-2 md:col-span-1">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="bg-sky-100 p-2 sm:p-2.5 rounded-lg flex-shrink-0">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

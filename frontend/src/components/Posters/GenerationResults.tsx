...
const GenerationResults: React.FC<GenerationResultsProps> = ({
  ...
  if (isGenerating) {
    return (
      <div className="bg-white/80 backdrop-blur-md rounded-2xl p-12 shadow-xl border-2 border-sky-100">
        <div className="flex flex-col items-center justify-center">
          <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-sky-500 mb-6"></div>
    ...
    return (
      <div className="bg-white/80 backdrop-blur-md rounded-2xl p-12 shadow-xl border-2 border-sky-100">
        <div className="flex flex-col items-center justify-center text-center">
          <svg
            className="w-24 h-24 text-sky-200 mb-4"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border-2 border-sky-200/60 overflow-hidden">
      ...
      <div className="p-4 sm:p-6 border-b-2 border-sky-200/60 flex justify-between items-center">
        <div>
          ...
          {posters.map((poster, index) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-sky-500 text-white rounded-full p-3 shadow-lg hover:bg-sky-600 transition-colors"

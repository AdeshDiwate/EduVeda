        ...
        {showInput && (
          <div className="flex items-center gap-2">
            <input
              ...
              className="border border-gray-300 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  addCustomCategory();
            ...
            <button
              ...
              className="bg-sky-500 text-white rounded-full p-2 hover:bg-sky-600"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-800 mb-2 sm:mb-3">
            <span className="text-sky-400">Posters</span> that Standout
          </h1>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-5 sm:p-6 shadow-xl border-2 border-sky-200/60">
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-sky-200 focus:border-sky-300 bg-white text-gray-900 transition-all"
              >
                {languages.map((lang) => (

...
const Card: React.FC<CardProps> = ({
  ...
  return (
    ...
    >
      <div className={`bg-white rounded-xl shadow-lg border ${isSelected ? 'border-sky-400' : 'border-gray-200'
        } overflow-hidden h-full flex flex-col`}>
        {/* Header */}
        <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-sky-50 to-sky-100/50 border-b border-sky-100">

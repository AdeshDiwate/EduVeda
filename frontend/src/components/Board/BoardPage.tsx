...
const BoardPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-sky-50 via-white to-sky-50/30">
      ...
      <div className="fixed top-4 right-4 z-50">
        <div className="relative">
          ...
          {showThinkingModal && (isGenerating || thinkingText) && (
            <div className="absolute top-full right-0 mt-2 w-96 bg-white rounded-xl shadow-xl border border-sky-200 overflow-hidden">
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-gradient-to-r from-sky-50 to-sky-100/50">
                <svg
      ...
      {(isSpacePressed || isPanning) && (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-none">
          <div className="bg-sky-500/90 text-white px-4 py-2 rounded-full shadow-lg">
            Panning...
          </div>
        </div>
      )}

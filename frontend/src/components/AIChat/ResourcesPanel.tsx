...
const ResourcesPanel: React.FC<ResourcesPanelProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="h-full flex flex-col bg-gradient-to-b from-white to-sky-50/30">
        <div className="p-6 border-b-2 border-sky-100 bg-white/50">
  ...
  if (error) {
    return (
      <div className="h-full flex items-center justify-center bg-gradient-to-b from-white to-sky-50/30">
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-white to-sky-50/30 overflow-hidden">
      {/* Header */}
      <div className="p-6 border-b-2 border-sky-100 bg-white/50">
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">
          Session Resources
        ...
        {files.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {files.map((file) => (
              <div
                key={file.fileId}
                className="bg-white/80 backdrop-blur-md rounded-xl p-4 border-2 border-sky-100 hover:border-sky-300 hover:shadow-lg transition-all duration-200"
              >
                {/* File Icon & Name */}
                ...
                <div className="flex gap-2">
                  {/* View Button */}
                  <button
                    className="flex-1 px-3 py-2 rounded-lg transition-colors text-sm font-medium border flex items-center justify-center bg-sky-50 text-sky-600 hover:bg-sky-100 border-sky-200"
      ...
      {/* Footer Stats */}
      {files.length > 0 && (
        <div className="p-4 border-t-2 border-sky-100 bg-sky-50/50">

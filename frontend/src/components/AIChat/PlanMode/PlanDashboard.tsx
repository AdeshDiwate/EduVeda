...
const PlanDashboard: React.FC<PlanDashboardProps> = ({
    ...
    return (
        <div className="h-full overflow-y-auto p-6 bg-gradient-to-b from-white to-sky-50/30">
            {/* Header */}
            <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="bg-sky-50 text-sky-700 px-3 py-1.5 rounded-lg border border-sky-200 text-sm font-medium">
            ...
            {documents.length === 0 ? (
                <div className="text-center py-16">
                    <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-sky-100 to-amber-100 rounded-full flex items-center justify-center">

...
const DocumentTree: React.FC<DocumentTreeProps> = ({
    ...
    if (isLoadingTree) {
        return (
            <div className="bg-white rounded-xl border-2 border-sky-100 overflow-hidden p-6">
    ...
    return (
        <div className="bg-white rounded-xl border-2 border-sky-100 overflow-hidden">
            {/* Document Header */}
            <div className="p-4 bg-gradient-to-r from-sky-50 to-amber-50 border-b border-sky-100">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${isLoading
                                        ...
                                        : 'bg-gradient-to-r from-sky-500 to-amber-500 text-white hover:from-sky-600 hover:to-amber-600 shadow-md hover:shadow-lg'
                                    }
                                `}
                            >
                                {isLoading ? (

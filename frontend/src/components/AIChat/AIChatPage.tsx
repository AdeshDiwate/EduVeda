...
const AIChatPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col overflow-hidden bg-gradient-to-br from-sky-50 via-white to-sky-50/30" style={{ height: '100dvh' }}>
      ...
      {/* Header Section */}
      <div className="flex-shrink-0 px-4 sm:px-6 md:px-8 py-2 sm:py-3 border-b-2 border-sky-100 bg-white/50 backdrop-blur-sm max-w-[1920px] w-full mx-auto mt-[100px] sm:mt-[104px]">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-800">
              <span className="text-sky-400">RAG-Powered</span> AI Chat
            </h1>
          ...
          <div className="flex items-center gap-3">
            <div className="flex gap-2 bg-white/80 backdrop-blur-md rounded-lg p-1 border-2 border-sky-100">
              <button
            ...
            <button
              ...
              className={`px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all flex items-center gap-1.5 ${activeTab === "plan"
                ...
                : "bg-white/80 text-gray-700 border-2 border-sky-200 hover:bg-sky-50 hover:border-sky-300"
                }`}
            >
              <span>📋</span>
              Plan
          ...
          <div className="flex items-center gap-3 ml-4">
            {/* Language Selector */}
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md rounded-lg p-1 border border-sky-200 shadow-sm">
              ...
              <select
                ...
                className="bg-transparent text-xs sm:text-sm font-bold text-sky-600 focus:outline-none cursor-pointer py-1 pr-1 max-w-[100px]"
              >
            ...
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md rounded-lg p-1 border border-sky-200 shadow-sm">
              ...
              <select
                ...
                className="bg-transparent text-xs sm:text-sm font-bold text-sky-600 focus:outline-none cursor-pointer py-1 pr-1"
              >
                {GRADE_LEVELS.map(g => (
      ...
      <div className="flex-1 min-h-0 flex overflow-hidden max-w-[1920px] w-full mx-auto">
        ...
        <button
          ...
          className="w-6 bg-white/80 hover:bg-sky-50 border-r-2 border-sky-100 flex items-center justify-center transition-colors"
            ...
            <div className="h-full flex items-center justify-center text-gray-500">
              <div className="text-center">
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2 bg-sky-400 text-white rounded-lg hover:bg-sky-500 transition-colors"
                >
                  Start New Chat
                </button>
              </div>

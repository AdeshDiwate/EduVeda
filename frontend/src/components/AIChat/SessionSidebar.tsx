...
const SessionSidebar: React.FC<SessionSidebarProps> = ({
  ...
  return (
    <div className="w-56 bg-white/80 backdrop-blur-md border-r-2 border-sky-100 h-full flex flex-col">
      {/* Header */}
      <div className="p-3 border-b-2 border-sky-100">
        <button
          onClick={onNewSession}
          className="w-full bg-gradient-to-r from-sky-400 to-sky-500 text-white px-3 py-2 rounded-lg font-medium hover:from-sky-500 hover:to-sky-600 transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm"
        >
          <svg
            className="w-4 h-4"
            fill="none"
                  ...
                  <div className="flex-1 min-w-0">
                    {editingSessionId === session.sessionId ? (
                      <input
                        ...
                        className="w-full text-xs font-semibold text-gray-900 bg-white border-2 border-sky-400 rounded px-1.5 py-0.5 focus:outline-none"
                      />
                    ) : (
                  ...
                  {editingSessionId !== session.sessionId && (
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-sky-100 rounded transition-colors flex-shrink-0"
                        title="Rename chat"
                      >
                        <svg
      ...
      {/* Footer - Compact */}
      <div className="p-2 border-t-2 border-sky-100 bg-sky-50/50 space-y-2">
        <a
          href="https://github.com/ayuxy027/EduVeda"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-full h-8 text-sky-600 hover:text-sky-700 hover:bg-sky-100 rounded-lg transition-all"
        ...
        <div className="text-xs text-gray-500 text-center">
          <p className="font-medium text-sky-600">EduVeda</p>
        </div>
      </div>
    </div>
  );

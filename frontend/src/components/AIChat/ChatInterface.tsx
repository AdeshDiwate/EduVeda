...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  return (
    <div className="h-full flex flex-col bg-white/50 overflow-hidden">
      {/* Messages Container */}
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-gradient-to-b from-white to-sky-50/30 min-h-0">
        {messages.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center px-4">
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-sky-100 to-sky-200 flex items-center justify-center">
                <svg
              ...
              <button
                ...
                className="px-6 py-2 bg-sky-400 text-white rounded-lg hover:bg-sky-500 transition-colors font-medium"
              >
                Upload Document
              </button>
            </div>
                                ...
                                <div className="space-y-2">
                                  {[...message.sources]
                                    ...
                                    .map((source, idx) => (
                                      <div
                                        key={idx}
                                        className="bg-sky-50 rounded-lg p-3 border border-sky-200"
                                      >
                              ...
                              >
                                <div className="space-y-3 p-1">
                                  ...
                                  <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white border border-sky-200 text-sky-600 rounded-lg hover:bg-sky-50 transition-colors text-xs font-semibold"
                                  >
      ...
      {uploadProgress.length > 0 && (
        <div className="px-4 py-2 bg-sky-50 border-t border-sky-200 space-y-2">
      ...
      <div className="flex-shrink-0 border-t-2 border-sky-200 p-3 bg-white">
        {/* Hidden file input */}
        <input
          ref={fileInputRef}
          type="file"
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            onClick={() => fileInputRef.current?.click()}
            className="p-2.5 text-sky-600 hover:text-sky-700 bg-sky-50 hover:bg-sky-100 rounded-xl transition-all border-2 border-sky-200 hover:border-sky-300 flex-shrink-0"
          ...
          <button
            ...
            className={`p-2.5 rounded-xl transition-all flex-shrink-0 border-2 ${
              inputValue.trim() && !isLoading
                ? "bg-gradient-to-br from-sky-400 to-sky-500 text-white border-sky-400 hover:from-sky-500 hover:to-sky-600 shadow-md hover:shadow-lg"
        ...
        {uploadedFiles.length > 0 && (
          <div className="flex flex-wrap items-center gap-1.5 mt-2">
            ...
            {getExamplePrompts().map((prompt, index) => (
              <button
                key={index}
                className="text-xs bg-sky-50 text-sky-700 px-2.5 py-1 rounded-full hover:bg-sky-100 hover:text-sky-800 transition-all border border-sky-200 font-medium"

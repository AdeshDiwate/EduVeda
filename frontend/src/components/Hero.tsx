...
const Avatar = ({ src, alt }: { src: string; alt: string }) => {
    ...
    return (
        <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-sky-300 to-sky-500 rounded-full opacity-50"></div>
            {imageError ? (
                <div className="relative w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-sky-300 to-sky-500 border-2 border-white shadow-md"></div>
            ) : (
                <img
                    src={src}
                    alt={alt}
...
const Herobox = () => {
    ...
    const fallbackGradients = [
        "linear-gradient(135deg, #0ea5e9 0%, #38bdf8 50%, #bae6fd 100%)",
        ...
        <div className="bg-white px-4 sm:px-6 md:px-12 lg:px-20 py-8 sm:py-12 md:py-16">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-4 sm:gap-6 items-stretch">
                ...
                <div className="md:col-span-2 relative group">
                    <div className="relative h-full min-h-[250px] sm:min-h-[300px] md:min-h-[400px] rounded-xl overflow-hidden border-2 border-sky-400/20 hover:border-sky-400/40 transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-br from-sky-500 via-sky-400 to-sky-300 z-0"></div>
                        <img
                ...
                <div className="md:col-span-2 flex flex-col gap-4 sm:gap-6">
                    {/* Top Card - LMR */}
                    <div className="relative bg-white border-2 border-sky-400 rounded-xl p-4 sm:p-5 md:p-6 flex flex-col justify-center h-full hover:shadow-lg transition-all duration-300">
                        ...
                        <Link to="/posters" className="inline-block bg-sky-400 text-white border-2 border-sky-400 font-semibold px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm hover:bg-sky-500 hover:border-sky-500 transition-all duration-300 w-fit">
                            Try Generating Posters →
                        </Link>
                    </div>

                    {/* Bottom Card - LMR */}
                    <div className="relative bg-sky-400 border-2 border-sky-400 rounded-xl p-4 sm:p-5 md:p-6 md:px-8 flex flex-col justify-center h-full hover:shadow-lg transition-all duration-300">
                        <p className="text-lg sm:text-xl font-semibold text-white leading-relaxed mb-2 sm:mb-3">
                            AI-Powered Study <br />
                            Material Generator
                        </p>
                        <p className="text-xs sm:text-sm text-sky-50 mb-3 sm:mb-4 leading-relaxed">
                            Upload PDFs, PPTs & docs. Get summaries, quizzes, recall notes & more in 22+ languages.
                        </p>
                        <Link to="/lmr" className="inline-block bg-white text-sky-400 border-2 border-white font-semibold px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm hover:bg-sky-50 hover:text-sky-500 transition-all duration-300 w-fit">
                            Try LMR →
                        </Link>
                    </div>
                </div>
                ...
                <div className="md:col-span-2 relative group">
                    <div className="relative h-full min-h-[250px] sm:min-h-[300px] md:min-h-[400px] rounded-xl overflow-hidden border-2 border-sky-400/20 hover:border-sky-400/40 transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-bl from-sky-500 via-sky-400 to-sky-300 z-0"></div>
                        <img
            ...
            <div className="px-2 sm:px-4 md:px-6 lg:px-8 relative overflow-hidden flex justify-center items-start md:items-center">
                ...
                <div className="max-w-7xl my-2 mx-auto">
                    ...
                    <div className="text-center mb-8 sm:mb-12 md:mb-16 relative z-10">
                        <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl tracking-tight font-semibold text-sky-400 mb-2 px-2">
                            ...
                            <span className="inline-flex items-center align-middle flex-wrap justify-center gap-1 sm:gap-2 md:gap-3">
                                <span className="inline-flex items-center justify-center border-2 border-sky-400 rounded-full px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 lg:px-6 lg:py-3 transform -rotate-6 origin-center mr-1 sm:mr-2 md:mr-3">
                                    <svg className="text-sky-400 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span
                                    className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl text-sky-400 font-semibold"
                                    style={{
                                ...
                                <span className="inline-flex items-center mx-1 sm:mx-2 md:mx-3 align-middle">
                                    <span className="inline-flex items-center justify-center border-2 border-sky-400 rounded-full px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 lg:px-6 lg:py-3 transform rotate-6 origin-center">
                                        <svg className="text-sky-400 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-gray-800 text-xs sm:text-sm md:text-lg lg:text-xl max-w-[90%] sm:max-w-[85%] md:max-w-[80%] mt-3 sm:mt-4 mx-auto px-4 sm:px-6 md:px-10 mb-6 sm:mb-8 leading-relaxed">
                            Experience best in class Modern, lightweight, and AI enabled Learning Experience with EduVeda.
                        </p>

                        {/* Buttons */}
                        <div className="flex flex-row gap-3 sm:gap-4 justify-center items-center px-4">
                            <Link to="/benchmarks" className="bg-sky-400 text-white border-2 border-sky-400 font-semibold px-5 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full text-xs sm:text-sm md:text-base shadow-md hover:shadow-lg hover:bg-sky-500 hover:border-sky-500 transition-all duration-300 whitespace-nowrap">
                                View Benchmarks
                            </Link>
                            <Link to="/stitch" className="bg-white text-sky-400 border-2 border-sky-400 font-semibold px-5 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full text-xs sm:text-sm md:text-base shadow-md hover:shadow-lg hover:bg-sky-50 hover:border-sky-500 transition-all duration-300 whitespace-nowrap">
                                Try Stitch
                            </Link>
                        </div>
                    </div>

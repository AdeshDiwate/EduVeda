...
const StitchSessionSidebar: React.FC<StitchSessionSidebarProps> = ({
  ...
  return (
    <div className="w-full bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border-2 border-sky-200/60 p-4 sm:p-5">
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-sky-400 to-sky-500 text-white rounded-lg font-medium hover:from-sky-500 hover:to-sky-600 transition-all duration-200 shadow-md hover:shadow-lg text-xs sm:text-sm"
        >
          <svg
              ...
              <div
                ...
                className={`group flex-shrink-0 w-48 sm:w-56 bg-gradient-to-br ${
                  currentSessionId === session.sessionId
                    ? "from-sky-50 to-sky-100 border-2 border-sky-300 shadow-md"
                    : "from-white to-gray-50 border-2 border-gray-200 hover:border-sky-200"
